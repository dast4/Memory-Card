...
Questions_list.append(Question('почему небо синее?', 'потому что' , 'нет' , 'да' , 'конешно'))
Questions_list.append(Question('в чём смысл жизни?' , 'да' , 'умереть', 'незнаю' , 'жить'))
Questions_list.append(Question('почему свет в холодильнике?', 'это пришельцы' , 'конешно' , 'незнаю' , 'да'))
Questions_list.append(Question('Кто ты?', 'человек' , 'пришелец' , 'незнаю' , 'вольтамперфазометр'))
Questions_list.append(Question('Кто презедент мира?', 'ПУТИН' , 'пришелец' , 'незнаю' , 'какойто чювак'))
Questions_list.append(Question('Правда, что в Месопотами Бог слепил человека?', 'да' , 'не' , 'незнаю' , 'это не бох а пришельцы'))
Questions_list.append(Question('самый сложный вопрос в мире 2 + 2?', '4' , '5000' , 'незнаю' , '12345676543456'))
app = QApplication([])
